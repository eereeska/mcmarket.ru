<div x-data="{open: false}" class="relative">
    <button class="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-300 focus:border-indigo-500 sm:text-sm" aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label">
...
<select name="sort">
    <option value="1">Последнее обновление</option>
</select>
</div>
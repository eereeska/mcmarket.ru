<div class="data data_compact">
    @if ($file->cover_path)
    <a href="{{ route('admin.file.edit', ['id' => $file->id]) }}" class="data__icon cover" style="background-image: url({{ $file->getCover() }})"></a>
    @else
    ...
    <div class="data__info">
        <h3 class="data__value">
            <ul class="breadcrumb">
                ...
                @endif
                <li class="breadcrumb__item breadcrumb__item_active"><a href="{{ route('admin.file.edit', ['id' => $file->id]) }}">{{ $file->name }}</a></li>

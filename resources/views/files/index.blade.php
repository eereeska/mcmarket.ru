        ...
        <section class="section">
            ...
            <div class="section__content">
                <form action="{{ route('home') }}">
                    ...
                    <div class="select">
                        <input type="hidden" name="type" value="all" class="select__data">
                        <div class="select__selected">Все</div>
                        <div class="select__options">
                            <div class="select__option select__option_selected" data-value="all">Все</div>
                            <div class="select__option" data-value="free">Бесплатные</div>
                            <div class="select__option" data-value="paid">Платные</div>
                            <div class="select__option" data-value="nulled">Nulled</div>
                        </div>
                    </div>
                    <label for="type" class="label">От пользователя</label>
                    <div class="select">
                        <input type="hidden" name="from" class="select__data">
        ...
        <section class="section">
            ...
            <div class="section__content">
                ...
                <a href="#" class="data data_compact">
                    <div class="data__icon icon icon--file"></div>
                    <div class="data__info">
                        <h3 class="data__value">В очереди</h3>
                    </div>
                </a>
            </div>
        </section>

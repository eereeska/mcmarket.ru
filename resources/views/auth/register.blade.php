...
<form method="post" action="{{ route('register') }}">
    ...
    <p class="center mt-30 mb-30">Создавая аккаунт, я соглашаюсь с <a href="#" target="_blank">правилами MCMarket</a> и даю согласие на <a href="#" target="_blank">обработку персональных данных</a>.</p>
